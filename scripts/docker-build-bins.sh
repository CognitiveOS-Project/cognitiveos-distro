...
for repo in $REPOS; do
    git clone --depth=1 "git@github.com:CognitiveOS-Project/${repo}.git" "/src/${repo}"
done

mkdir -p /src/inference/vendor
git clone --depth=1 git@github.com:ggerganov/llama.cpp.git /src/inference/vendor/llama.cpp
